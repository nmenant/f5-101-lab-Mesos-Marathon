...
::
	...
	# On master1
	echo "10.1.10.1" | sudo tee /etc/mesos-master/ip
	echo "master1.my-lab" | sudo tee /etc/mesos-master/hostname
	echo "zk://10.1.10.1:2181,10.1.10.2:2181,10.1.10.3:2181/mesos" | sudo tee /etc/mesos/zk

	# On master2
	echo "10.1.10.2" | sudo tee /etc/mesos-master/ip
	echo "master1.my-lab" | sudo tee /etc/mesos-master/hostname
	echo "zk://10.1.10.1:2181,10.1.10.2:2181,10.1.10.3:2181/mesos" | sudo tee /etc/mesos/zk

	# On master3
	echo "10.1.10.3" | sudo tee /etc/mesos-master/ip
	echo "master1.my-lab" | sudo tee /etc/mesos-master/hostname
	echo "zk://10.1.10.1:2181,10.1.10.2:2181,10.1.10.3:2181/mesos" | sudo tee /etc/mesos/zk
